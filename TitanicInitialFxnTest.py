...
ALso, deals with functions to get to know the data better.
"""
...
def checkingcoldatatypes():
    ...
    print("There are 5 columns that are integers and objects, and 2 columns that are floats.\n")
    print(df.dtypes)
    ...
    print("\n3. Shows the column data type & how many non-null values there are:\n")
    print("Age, Cabin & Embarked all have non null values, and other 9 columns have all data.")
    print("Cabin has the most non-null values (204), while Embarked has the least (889).\n")
    print(df.info())
